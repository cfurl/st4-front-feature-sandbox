# meant to work in a docker container
...
#out_dir   <- "gt_table/output" # local
out_dir <- "/home/data" # docker
tmp_png   <- file.path(out_dir, "edwards_basin_table_tmp.png")
final_png <- file.path(out_dir, "edwards_basin_table.png")
#if (!dir.exists(out_dir)) dir.create(out_dir, recursive = TRUE, showWarnings = FALSE)

#gtsave(gt_basin_24hr, filename = tmp_png, vwidth = 1600, vheight = 500, zoom = 2)
